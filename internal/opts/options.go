...
type Options struct {
	...
	OutputModelsPackageImportPath string            `json:"output_models_package_import_path,omitempty" yaml:"output_models_package_import_path"`
	...
	OutputQueryFilesPackage       string            `json:"output_query_files_package,omitempty" yaml:"output_query_files_package"`
